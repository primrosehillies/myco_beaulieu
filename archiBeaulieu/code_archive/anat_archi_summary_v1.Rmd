...
```{r}
cernes <- read.csv("cernes-02.csv", header=T)
...
anat <- anat %>%
  left_join(cernes_wide, by = "id_amap")

write.csv(anat, file = "anat_9.csv")
```
...
```{r}
vessel <- read.csv(file = "vessel_6.csv", header = T)
...
numerical_cols <- c("image_surface_µm2", "image_surface_rectified_µm2.x", 
                    ...
                    "Ring_Size_Year_2024", "Ring_Size_Year_2023", "Ring_Size_Year_2022", "Ring_Size_Year_2021")
...
#####
write.csv(anat_combined, "anat_combined_5.csv")
```
...
anat_combined <- read.csv("anat_combined_5.csv", header = T, stringsAsFactors = T)
...
#####
write.csv(anarchi, "anarchi_5.csv")
```
