...
square_files <- list.files(path = "square/square-per_year/b&w-all_done/pictures", pattern = "\\.jpg$", full.names = TRUE)
...
anat_complete <- anat %>%
  ...
  select(number, organ, year, c("ring_length_µm", "mean_vessel_size_µm2", "sum_vessel_area_µm2", "vessel_density_per_mm2", "vessel_area", "Kth"))


anat_wide <- anat_complete %>%
  pivot_wider(names_from = c(organ, year),
              values_from = c("ring_length_µm", "mean_vessel_size_µm2", "sum_vessel_area_µm2", "vessel_density_per_mm2", "vessel_area", "Kth"))
...
#####
#write.csv(anarchi, "anat_archi_per_year.csv")
```
